...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while index < num_rolls:
        curr_score = dice()
        if pig_out != True and curr_score == 1:
            pig_out = True
        score += curr_score
        index += 1
    if pig_out == True:
...
def is_swap(player_score, opponent_score):
    ...
    b_ones, b = b % 10, b // 10
    b_tens = b % 10
    a_diff = abs(a_ones - a_tens)
    b_diff = abs(b_ones - b_tens)
    if a_diff == b_diff:
        return True
    return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            strategy_roll = strategy0(score0, score1)
            score0 += take_turn(strategy_roll, score1, dice)
        if player == 1:
            strategy_roll = strategy1(score1, score0)
            score1 += take_turn(strategy_roll, score0, dice)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while roll <= 10:
        ...
        average_score = average(roll, dice)
        if average_score > previous_average_score:
            highest_average_roll = roll
            previous_average_score = average_score
        roll += 1
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if is_swap(bacon_score, opponent_score) and bacon_score < opponent_score:
        return 0
    if free_bacon(opponent_score) >= margin and not is_swap(bacon_score, opponent_score):
        return 0
    return num_rolls  # Replace this statement
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if diff > 10:
        ...
        roll = swap_strategy(score, opponent_score, 10, 4)
