...
def group_by_centroid(restaurants, centroids):
    ...
    for r in restaurants:
        ...
        cluster.append([closest_centroid, r])
...
def find_centroid(cluster):
    ...
    # BEGIN Question 5
    longtitude = mean([restaurant_location(x)[0] for x in cluster])
    latitude = mean([restaurant_location(x)[1] for x in cluster])
